(function () {
  ...
  const DICT = {
    zh: {
      ...
      newPassword: '新密码',
      editOldPasswordHint: '持有 manage token 时会自动解密，通常无需填写；恢复失败时再输入当前密码',
    ...
    en: {
      ...
      editOldPasswordHint:
        'Decrypted automatically with your manage token — usually leave this empty; enter the current password only if recovery fails',
