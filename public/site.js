(function () {
  ...
  const DICT = {
    zh: {
      tagline: '静态 HTML 分享',
      newShare: '新建分享',
      uploadSubtitle: '选择 HTML 文件，设置链接，即可创建分享',
      htmlFile: 'HTML 文件',
      pickFile: '选择 .html 文件',
      ...
      moreOptions: '更多选项',
      moreOptionsMeta: '标题 · 作者 · 描述 · 标签 · 有效期 · 密码',
    ...
    en: {
      ...
      newShare: 'New share',
      uploadSubtitle: 'Choose an HTML file, set its link, and create the share',
      htmlFile: 'HTML file',
      ...
      moreOptionsMeta: 'Title · author · description · tags · expiry · password',
