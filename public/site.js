(function () {
  ...
  const DICT = {
    zh: {
      ...
      fileTooLargeAfterCompress: '压缩后仍超过 {size}KB，可能内含视频或无法进一步压缩的图片',
      fileCompressed: '已自动压缩图片',
      contentEmpty: '内容不能为空',
      alias: 'Alias',
      customAlias: '自定义链接',
      optionalShort: '可选',
    ...
    en: {
      ...
      fileTooLargeAfterCompress: 'Still exceeds {size}KB after compression; it may contain video or images that cannot be compressed further',
      fileCompressed: 'Images auto-compressed',
