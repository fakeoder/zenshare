(function () {
  ...
  const DICT = {
    zh: {
      ...
      moreOptions: '更多选项',
      moreOptionsMeta: '全部可选 · 标题 · 作者 · 描述 · 标签 · 保留时长 · 访问范围',
      ...
      visibilityPrivateHint: '私密分享不会出现在公开目录，需要密码才能查看',
      passwordRequired: '私密分享需要设置访问密码',
    ...
    en: {
      ...
      moreOptionsMeta: 'All optional · title · author · description · tags · retention · visibility',
      ...
      visibilityPrivateHint: 'Private shares stay out of the public directory and require a password',
      passwordRequired: 'Private shares require an access password',
