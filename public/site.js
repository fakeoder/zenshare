(function () {
  ...
  const DICT = {
    zh: {
      ...
      manageableHint: '启用后可随时修改、更新和删除此分享；需要先在右上角加载 Token',
      tokenWarn: '请妥善保管 token 文件，它是管理分享的唯一凭证，丢失后无法找回',
      tokenGenerate: '生成新 Token',
      ...
      tokenPromptText: '点击右上角钥匙图标，导入或生成 Token',
      ...
      tokenGenerateConfirm:
        '生成新 Token 后，旧 Token 管理的分享将无法再管理。确定继续吗？',
    ...
    en: {
      ...
      manageableHint:
        'Edit, update and delete later from My Shares; requires a token (top-right key icon)',
      tokenWarn:
        'Keep your token file safe — it is the only way to manage your shares. Losing it means losing access forever.',
      tokenGenerate: 'Generate new token',
      ...
      tokenPromptText: 'Click the key icon in the top-right to import or generate a token',
      ...
      tokenGenerateConfirm:
        'A new token will be created. Shares bound to the old token will become unmanageable. Continue?',
      tokenClearConfirm:
