(function () {
  ...
  const DICT = {
    zh: {
      ...
      editShare: '编辑分享',
      editFailed: '更新失败',
      editFileHint: '不选择文件只更新基本信息；修改加密状态或密码必须重新选择文件',
      editRequiresFile: '更改加密状态需要重新选择文件',
      editPasswordHint: '重新选择文件后可设置新的访问密码',
      deleteShare: '删除',
    ...
    en: {
      ...
      editFileHint:
        'Without a new file only basic info is updated; changing encryption or the password requires re-selecting the file',
      editRequiresFile: 'Changing encryption requires re-selecting the file',
      editPasswordHint: 'Pick a new file to set a new access password',
      deleteShare: 'Delete',
