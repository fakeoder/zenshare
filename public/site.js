(function () {
  ...
  const DICT = {
    zh: {
      ...
      passwordRequired: '默认自动生成强密码，也可手动修改；密码只在浏览器端加密，服务端不保存',
      ...
      manageableHint: '创建后可在“我的分享”里修改、更新和删除；token 是唯一管理凭证，丢失无法找回',
      ...
      currentPasswordPlaceholder: '用于解密当前内容',
      newPassword: '新密码',
      editOldPasswordHint: '修改或取消访问密码时需要先解密当前内容',
      editOldPasswordRequired: '请输入当前密码',
      editWrongPassword: '当前密码不正确',
    ...
    en: {
      ...
      passwordRequired: 'A strong password is generated by default; you can edit or regenerate it. It is encrypted in your browser and never stored by the server',
      ...
      manageableHint:
        'Edit, update and delete it later from My shares; the token is the only credential and cannot be recovered',
      tokenWarn:
      ...
      currentPasswordPlaceholder: 'Used to decrypt the current content',
      newPassword: 'New password',
      editOldPasswordHint:
        'Changing or removing the password decrypts the current content first',
      editOldPasswordRequired: 'Enter your current password',
      editWrongPassword: 'Incorrect current password',
